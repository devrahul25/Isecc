    ...
    <div className="flex flex-col flex-1 pt-20 md:pt-24">
      ...
      <section className="relative pt-40 pb-32 lg:pt-48 lg:pb-40 overflow-hidden bg-slate-900 hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 text-center">
          <h1 className="text-sm font-bold text-blue-400 uppercase tracking-[0.2em] mb-6">
            Our Board
          </h1>
          ...
          <p className="text-xl text-blue-100/90 font-light max-w-3xl mx-auto leading-relaxed">
            We proudly welcome{" "}
            <strong className="text-blue-100/90 font-semibold">
              {" "}
              Jayesh Menon
            </strong>{" "}
            as the{" "}
            ...
            . His leadership and international experience will help shape
            ISECC's mission of advancing strategic economic partnerships and
            global corridor development.
          </p>
        </div>
      </section>
          ...
          <article className="max-w-4xl mx-auto">
            ...
            <div className="rounded-3xl overflow-hidden shadow-2xl relative aspect-[16/9] md:aspect-[21/9] group w-full mb-12">
              <img
                ...
                alt="Jayesh Menon"
                className="w-full h-full object-cover object-top scale-150 origin-top transition-transform duration-700"
              />
            ...
            <div className="space-y-8 text-slate-600 font-light text-lg md:text-xl leading-relaxed">
              <p>
                ...
                <strong className="text-slate-800 font-semibold">
                  {" "}
                  Founder & Principal Advisor of Vars Boffin Business Advisors
                </strong>
                , an international advisory platform for international market
                entry, investment facilitation, and strategic expansion and
                collaboration. Jayesh is an international trade and investment
                professional with over 25 years of experience across global
                markets, working at the intersection of enterprise growth,
                institutional collaboration, and economic development.
              </p>
              <p>
                His work focuses on enabling organisations to move beyond market
                access and build sustainable international presence through
                structured advisory, institutional connectivity, and global
                partnerships. Jayesh's career spans engagements across North
                America, the Middle East, Asia, and emerging markets, where he
                has worked with:
              </p>

              <ul className="space-y-0 pl-2 mt-[-25px]">
                {[
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 w-full py-10">
          <div className="bg-slate-900/45 backdrop-blur-md border border-white/10 p-12 md:p-20 rounded-[2.5rem] shadow-[0_24px_50px_rgba(0,0,0,0.5)] relative overflow-hidden">
            ...
            <h3 className="relative z-10 text-2xl md:text-3xl lg:text-4xl text-white font-light leading-relaxed mb-6">
              Formal establishment and constitution of the ISECC Board are
              currently underway.
            </h3>
